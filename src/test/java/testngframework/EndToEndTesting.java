...
public class EndToEndTesting {
	...
	public void fullTest() throws InterruptedException
	{
		...
		driver.findElement(By.id("input-email")).sendKeys("leoganapathy5699@gmail.com");
		driver.findElement(By.id("input-password")).sendKeys("Opencart@000");
		...
		driver.findElement(By.id("input-payment-firstname")).sendKeys("Anjana Sharanya");
		...
		driver.findElement(By.id("input-payment-address-1")).sendKeys(" Municipal Office ");
		
		Thread.sleep(2000);
		
		driver.findElement(By.id("input-payment-city")).sendKeys("Andhra Pradesh");
		
		Thread.sleep(2000);
		
		driver.findElement(By.id("input-payment-postcode")).sendKeys("518222");
